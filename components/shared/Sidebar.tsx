...
export function Sidebar() {
  ...
  return (
    <aside className="w-81 bg-[#FFFFFF03] backdrop-blur-[27px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] border-r border-[rgba(255,255,255,0.01)] h-auto min-h-screen sticky top-0 flex flex-col">
