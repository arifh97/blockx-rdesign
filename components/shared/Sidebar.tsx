...
export function Sidebar() {
  ...
  return (
    <aside className="w-81 bg-[#FFFFFF03] backdrop-blur-[27px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] border-r border-border h-auto min-h-screen sticky top-0 flex flex-col">
      ...
      <div className="px-3">
        <div className="active-order mb-10 w-full px-3.75 py-6 bg-[rgba(7,16,23,0.30)] backdrop-blur-[3.78947377204895px] border-[0.632px] border-white/10 rounded-[18px]">
          ...
          <div className="px-3.25 relative z-1 overflow-hidden bg-[rgba(255,255,255,0.01)] backdrop-blur-[3.78947377204895px] border-[0.632px] border-white/10 rounded-[12px] pt-6.5 pb-3.75">
            ...
            <div className="btns flex gap-1 justify-center items-center">
              <button className="relative grow rounded-[12px] py-2 px-2.5 z-1 flex items-center gap-1 text-xs font-medium text-white cursor-pointer hover:bg-[rgba(255,255,255,0.05)] transition-all duration-300 border border-solid border-transparent hover:border-white/10">
                <Image src="btn-bg3.png" className="absolute top-0 left-0 w-full h-full -z-1" alt="" />
            ...
            <Image src="active-order-shap.png" className="absolute bottom-0 right-0 w-auto h-full -z-1" alt="" />
          </div>
        </div>
      </div>
