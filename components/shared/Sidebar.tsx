...
export function Sidebar() {
  ...
  return (
    <aside className="w-81 bg-[#FFFFFF03] border-r border-[rgba(255,255,255,0.01)] h-auto min-h-screen top-0 flex flex-col">
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              href={item.href}
              className={cn(
                'navigation-item flex items-center gap-3 px-5 py-4 rounded-[100px] border text-sm lg:text-lg font-medium transition-colors',
                isActive
        ...
        <div className="active-order mb-10 w-full px-3.75 py-4 rounded-[18px] relative">
          ...
          <div className="px-3.25 relative z-1  pt-4 pb-3.75  rounded-[12px] overflow-hidden">
            ...
            <div className="btns flex gap-1 justify-center items-center">
              ...
              <button className="relative grow rounded-[29px] py-2 px-2.5 z-1 flex items-center gap-1 text-xs font-medium text-white cursor-pointer hover:bg-[rgba(255,255,255,0.05)] transition-all duration-300 bg-[rgba(255,255,255,0.02)] border border-solid border-[rgba(255,255,255,0.05)] hover:border-white/10">
                 <span className="pointer-events-none absolute inset-0  rounded-[inherit]  p-[1px]  before:absolute before:inset-0  before:rounded-[inherit]  before:bg-[linear-gradient(180deg,rgba(255,255,255,0.05),rgba(255,255,255,0),rgba(255,255,255,0.05))] before:content-[''] z-[-1]"/>
