...
export function Sidebar() {
  ...
  return (
    <aside className="w-81 bg-[#FFFFFF03] backdrop-blur-[27px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] border-r border-border h-auto min-h-screen sticky top-0 flex flex-col">
      ...
      <div className="px-3">
        <div className="active-order mb-10 w-full px-3.75 py-4 bg-[rgba(7,16,23,0.30)] backdrop-blur-[3.78947377204895px] border-[0.632px] border-white/5 rounded-[18px]">
          ...
          <div className="px-3.25 relative z-1 overflow-hidden bg-[rgba(255,255,255,0.01)] backdrop-blur-[3.78947377204895px] border-[0.632px] border-white/5 rounded-[12px] pt-4 pb-3.75">
